...
class History():
    ...
    def menu(self):
        ...
        print(f"Winner team was {winner_team[0][8]} using FIGHTING tactic: focus {winner_team[0][6]} and HEALING tactic: focus {winner_team[0][7]}")
        for w in winner_team:
            print(f"  =>{w[1]}, {w[2]} {w[3]} {'DEAD' if w[5] == 0 else f'{w[5]} hp'}")
        print("")
        print(f"Loser team was {loser_team[0][9]} using FIGHTING tactic: focus {loser_team[0][6]} and HEALING tactic: focus {loser_team[0][7]}")
        for l in loser_team:
            print(f"  =>{l[1]}, {l[2]} {l[3]} {'DEAD' if l[5] == 0 else f'{l[5]} hp'}")